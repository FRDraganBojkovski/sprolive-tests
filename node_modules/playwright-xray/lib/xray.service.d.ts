...
export declare class XrayService {
    ...
    private dryRun;
    private runResult;
    private limitEvidenceSize;
    private isXrayCloudAuthenticated;
    constructor(options: XrayOptions);
    createRun(results: XrayTestResult, execInfo: ExecInfo): Promise<void>;
    private initialzeJiraConnection;
    private postResultToJira;
    private isFlaky;
    private trimEvidence;
    private addExecutedBy;
}
export {};
